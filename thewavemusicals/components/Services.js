        ...
        <div className="flex flex-col my-24 py-8  items-center">
            ...
            <div className="flex flex-row flex-wrap items-center">
                {services_list.map((service, index) => (
                    ...
                    <div key={index} className="m-4 border rounded-full py-3 px-6 text-xl font-normal text-gray-300 transition duration-500 ease-in-out hover:bg-gray-700 transform -translate-y-1 hover:scale-110" >
